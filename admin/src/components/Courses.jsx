  ...
  return (
    <Box sx={{ gap: 30 }}>
      <Box>
        ...
        <Box>
          {value === 'Monday' && <Course courses={monday} />}
          {value === 'Tuesday' && <Course courses={tuesday} />}
          {value === 'Wednesday' && <Course courses={wednesday} />}
          {value === 'Thursday' && <Course courses={thursday} />}
          {value === 'Friday' && <Course courses={friday} />}
          {value === 'Saturday' && <Course courses={saturday} />}
          {value === 'Sunday' && <Course courses={sunday} />}
        </Box>
      </Box>
    </Box>
  );
